...
class Configs():
    ...
    def __init__(self):
        ...
        self.BATCH_SIZE = 1
        self.EPISODES = 100000 # training episodes
        ...
        self.OBJ_MESH_DIR = os.path.abspath('objects/blocks/')  # Directory containing 3D mesh files (.obj) of objects to be added to simulation
        self.TEXTURE_DIR = os.path.abspath('objects/textures/')  # Directory for desktop texture

        self.MIN_DEPTH_ARR = 0.45#0.50472337 #np.min(depth_arrmin:   ,max:
        self.MAX_DEPTH_ARR = 0.95#0.9083122
