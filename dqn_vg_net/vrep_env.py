...
class ArmEnv(object):
    # action_dim = 3
    # state_dim = (227,227,3) #  x = tf.placeholder(tf.float32, [None, 227, 227, 3])
    dt = .1  # refresh rate
    arm_lr = 100
    grab_counter = 0
    ...
    def __init__(self):
        ...
        self.robot = Robot(self.obj_mesh_dir, self.num_obj, self.workspace_limits, is_testing, test_preset_cases, test_preset_file)
